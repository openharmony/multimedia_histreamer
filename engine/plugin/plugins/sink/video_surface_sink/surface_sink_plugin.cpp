...
Status SurfaceSinkPlugin::Prepare()
{
    ...
    if (formatStr == std::to_string(PixelFormat::PIXEL_FMT_RGBA_8888)) {
        ...
        surfaceFmt = PixelFormat::PIXEL_FMT_YCRCB_420_SP; // PIXEL_FMT_YCRCB_420_SP 在 hdi 上面播放颜色不对
    }
