...
public:
    ...
    virtual bool Configure(const std::shared_ptr<Plugin::TagMap> &upstreamMeta, Plugin::TagMap &upstreamParams,
                           Plugin::TagMap &downstreamParams) = 0;
    /**
     * push data
...
public:
    ...
    bool Configure(const std::shared_ptr<Plugin::TagMap> &upstreamMeta, Plugin::TagMap &upstreamParams,
                   Plugin::TagMap &downstreamParams) override;
