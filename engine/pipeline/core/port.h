...
public:
    ...
    virtual bool Configure(const std::shared_ptr<const Plugin::TagMap> &upstreamTag, Plugin::TagMap &upstreamParams,
                           Plugin::TagMap &downstreamParams) = 0;
    /**
     * push data
...
public:
    ...
    bool Configure(const std::shared_ptr<const Plugin::TagMap> &upstreamTag, Plugin::TagMap &upstreamParams,
                   Plugin::TagMap &downstreamParams) override;
