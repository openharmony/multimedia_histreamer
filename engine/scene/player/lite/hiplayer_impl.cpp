...
int32_t HiPlayerImpl::Pause()
{
    ...
    MEDIA_LOG_I("Pause State  from : %d ",  pipelineStates_.load());
    auto ret = CppExt::to_underlying(fsm_.SendEvent(Intent::PAUSE));
    MEDIA_LOG_I("Pause State  to : %d ",  pipelineStates_.load());
