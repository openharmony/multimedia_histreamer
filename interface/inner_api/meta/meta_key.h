...
public:
    ...
    static constexpr const char REQUIRED_IN_BUFFER_CNT[] =
        "regular.required.in.buffer.cnt"; ///< required buffer count of plugin; read only tag
    static constexpr const char REQUIRED_IN_BUFFER_SIZE[] =
        "regular.required.in.buffer.size"; ///< required buffer size of plugin; read only tag
    static constexpr const char REQUIRED_OUT_BUFFER_CNT[] =
        "regular.required.out.buffer.cnt"; ///< required buffer count of plugin; read only tag
    ...
    static constexpr const char MEDIA_CODEC_CONFIG[] =
        "media.codec.config"; ///< codec config. e.g. AudioSpecificConfig for mp4
